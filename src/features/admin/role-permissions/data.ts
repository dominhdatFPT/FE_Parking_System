...
export const permissionModules: Array<{ key: PermissionModule; label: string; description: string }> = [
  ...
  { key: 'vehicleRegistration', label: 'Đăng ký thẻ xe', description: 'Hồ sơ phương tiện và xét duyệt' },
...
export const defaultRoles: Role[] = [
  ...
  },
  {
    id: 'driver',
    name: 'Driver',
    description: 'Người đăng ký thẻ xe, mua gói, thanh toán và gửi hỗ trợ',
    status: 'Active',
    assignedUsers: 120,
    isSystemRole: true,
  },
...
export const defaultRolePermissions: RolePermissionSet = {
  ...
  staff: {
    ...
    vehicleRegistration: { view: true, create: false, edit: true, delete: false },
  ...
  driver: {
    ...
    vehicleRegistration: { view: true, create: true, edit: true, delete: false },
    payment: { view: true, create: true, edit: false, delete: false },
    pricingPolicy: readOnly,
    reporting: none,
    userManagement: none,
